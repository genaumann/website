...
export default async function Hero() {
  ...
  return (
    <section className="min-h-[calc(100vh-97px)] relative bg-background dark:bg-background flex flex-col items-center justify-center px-4 py-16 overflow-hidden">
      {/* Background Pattern */}
