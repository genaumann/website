...
export default async function PortfolioStatsPage() {
  ...
  return (
    <section className="py-12 bg-muted/20 font-oswald">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {entries.map((entry, index) => (
            <Link
              ...
              <div className="text-4xl font-bold mb-2 transition-transform ease-in-out group-hover:scale-150 group-focus:scale-150 text-primary">
                {entry.value}
              </div>
